"""
Django settings for statscape project.
...
WSGI_APPLICATION = "statscape.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "statscape_db"),
        "USER": os.getenv("DB_USER", "statscape_app"),
